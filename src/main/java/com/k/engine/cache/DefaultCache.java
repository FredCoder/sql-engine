...
import com.k.engine.cache.utils.LinkedListNode;
...
public class DefaultCache<K, V> implements Cache<K, V> {
     ...
     */
    protected com.k.engine.cache.utils.LinkedList<K> lastAccessedList;

    /**
     * Linked list to maintain time that cache objects were initially added
     * to the cache, most recently added to oldest added.
     */
    protected com.k.engine.cache.utils.LinkedList<K> ageList;
     ...
     */
    private DefaultCache(String name, long maxSize, long maxLifetime) {
        this.name = name;
	...
	private final class CacheObjectCollection<V> implements Collection<V> {
        ...
        private CacheObjectCollection(Collection<DefaultCache.CacheObject<V>> cachedObjects) {
            this.cachedObjects = new ArrayList<DefaultCache.CacheObject<V>>(cachedObjects);
        }
